...
The tip labels are currently not have very clear gene names compared to those present in our metadata. We can change them!
...
We can add additional annotations like we would in `ggplot()` to our plot to make it more presentable
